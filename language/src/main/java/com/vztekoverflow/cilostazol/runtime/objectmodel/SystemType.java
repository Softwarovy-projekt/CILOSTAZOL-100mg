...
public enum SystemType {
  ...
  //          var type = CILOSTAZOLContext.getType(typePtr, module);
  ...
  //          setType(types, stack, topStack, pc, type2.getSystemType()); // ?? does this help at
  // all?
  ...
  //
  //  /**
  //   * This function should not be necessary and therefore should be deleted. If we get the type
  // from
  ...
  //   */
  //  private static void setTypeByStack(SystemType[] types, SystemType[] stack, int topStack, int
  // pc) {
  ...
  //      CLITablePtr token, SystemType[] stack, int topStack, ModuleSymbol module, boolean
  // isVirtual) {
  //    var method = getMethod(token, stack, topStack, module);
