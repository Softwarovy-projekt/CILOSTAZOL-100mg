...
/**
 * A class encapsulating raw bytecode bytes with an API to directly read opcodes (with prefixed
 * opcodes support) and operands, and patch the underlying bytecode.
 *
 * <p>Similar to {@link java.nio.ByteBuffer}, but stateless (not having an internal position stored)
...
public class BytecodeBuffer {
  ...
  /**
   * Gets the opcode of the instruction at the specified {@code position}. Supports prefixed
   * opcodes.
   *
  ...
  /**
   * Gets the address of the next instruction, handling variable instruction length. Supports
   * prefixed opcodes.
   *
  ...
  /**
   * Reads the immediate value from the instruction at the specified {@code position} as an unsigned
   * byte. Returns a short because Java doesn't have unsigned byte support. Supports prefixed
   * opcodes.
   *
   * @param position the index of the instruction
  ...
  /**
   * Reads the immediate value from the instruction at the specified {@code position} as an unsigned
   * short. Returns an int because Java doesn't have unsigned short support. Supports prefixed
   * opcodes.
   *
   * @param position the index of the instruction
  ...
  /**
   * Reads the immediate value from the instruction at the specified {@code position} as an unsigned
   * int. Returns a long because Java doesn't have unsigned short support. Supports prefixed
   * opcodes.
   *
   * @param position the index of the instruction
   ...
   *
   * <p>It is the caller's responsibility to never call this method in compilation and invalidate
  ...
  /**
   * Reads the immediate value from the instruction at the specified {@code position} as a {@link
   * CLITablePtr}. Supports prefixed opcodes.
   *
   * @param position the index of the instruction
  ...
  /**
   * Returns the number of bytes taken by instruction prefixes. Used for finding the beginning of
   * immediate values.
   *
   * @param position the index of the instruction
