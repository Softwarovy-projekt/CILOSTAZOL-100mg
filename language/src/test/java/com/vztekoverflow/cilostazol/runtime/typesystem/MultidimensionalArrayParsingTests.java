...
public class MultidimensionalArrayParsingTests extends TestBase {
  public static Stream<Arguments> provideDesiredMethods() {
    return Stream.of(
            ...
            Arguments.of("System::Void", ".ctor", new String[]{"System::Int32", "System::Int32", "System::Int32"}),
            ...
            Arguments.of("System::Void", "Set", new String[]{"T", "System::Int32", "System::Int32"}),
            Arguments.of("System::Void", "Set", new String[]{"T", "System::Int32", "System::Int32", "System::Int32"}),
            Arguments.of("System::Void", "Set", new String[]{"T", "System::Array"}),
            ...
            Arguments.of("T", "Get", new String[]{"System::Array"}),
            Arguments.of("System::Void", "Set", new String[]{"T", "System::Int64", "System::Int64"}),
            Arguments.of("System::Void", "Set", new String[]{"T", "System::Int64", "System::Int64", "System::Int64"}),
            Arguments.of("System::Void", "Set", new String[]{"T", "System::Array"}),
            ...
            Arguments.of("System::Int32", "System.Collections.IList.Add", new String[]{"System::Object"}),
            Arguments.of("System::Void", "System.Collections.IList.Clear", new String[]{}),
            Arguments.of("System::Boolean", "System.Collections.IList.Contains", new String[]{"System::Object"}),
            Arguments.of("System::Int32", "System.Collections.IList.IndexOf", new String[]{"System::Object"}),
            Arguments.of("System::Void", "System.Collections.IList.Insert", new String[]{"System::Int32", "System::Object"}),
            Arguments.of("System::Void", "System.Collections.IList.Remove", new String[]{"System::Object"}),
            Arguments.of("System::Void", "System.Collections.IList.RemoveAt", new String[]{"System::Int32"}),
            Arguments.of("System::Object", "System.Collections.IList.get_Item", new String[]{"System::Int32"}),
            Arguments.of("System::Void", "System.Collections.IList.set_Item", new String[]{"System::Int32", "System::Object"}),
            Arguments.of("System::Int32", "System.Collections.IStructuralComparable.CompareTo", new String[]{"System::Object", "System.Collections::IComparer"}),
            Arguments.of("System::Boolean", "System.Collections.IStructuralEquatable.Equals", new String[]{"System::Object", "System.Collections::IEqualityComparer"}),
            Arguments.of("System::Int32", "System.Collections.IStructuralEquatable.GetHashCode", new String[]{"System.Collections::IEqualityComparer"}),
            Arguments.of("System::Int32", "GetFlatIndex", new String[]{"System::Int32", "System::Int32"}),
            Arguments.of("System::Int32", "GetFlatIndex", new String[]{"System::Int32", "System::Int32", "System::Int32"}),
  ...
  public void testContainsDesiredMethods(String returnType, String methodName, String[] parameterTypes) {
    final String projectName = "CILOSTAZOLInternalImpl";
    CILOSTAZOLContext ctx = init(getDllPath(projectName));
    AssemblyIdentity assemblyIdentity = getAssemblyID(projectName);
    ...
    assertTrue(Arrays.stream(type.getMethods())
            .anyMatch(method -> method.getReturnType().getType().toString().equals(returnType)
                                && method.getName().equals(methodName)
                                && Arrays.equals(Arrays.stream(method.getParameters())
                    .map(param -> param.getType().toString()).toArray(), parameterTypes)));
  }
  ...
  public void testContainsDesiredFields(String fieldType, String fieldName) {
    ...
    assertTrue(Arrays.stream(type.getFields())
            .anyMatch(field -> field.getType().toString().equals(fieldType)
